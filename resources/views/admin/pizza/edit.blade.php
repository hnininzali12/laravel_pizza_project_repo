            ...
            <div class="col-md-9">
              ...
              <div class="card">
                <div class="card-header p-2">
                  <legend class="text-center">Pizza Information Edition</legend>
                </div>
                <div class="card-body">
                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" method="POST" action="{{route('admin#updatePizza',$pizza->pizza_id)}}" enctype="multipart/form-data">
                       @csrf
                        ...
                        <img class="img-thumbnail" src="{{asset('uploads/'.$pizza->image)}}" style="width:250px">
                        </div>
                        <div class="form-group row">
                          <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{old('name',$pizza->pizza_name)}}" id="inputName" name="name"placeholder="Enter pizza name">
                          </div>
                          @if($errors->has('name'))
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="inputName" value="{{old('price',$pizza->price)}}" name="price"placeholder="Enter price">
                            </div>
                            @if($errors->has('price'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputName" value="{{old('disPrice',$pizza->discount_price)}}" name="disPrice"placeholder="Enter discount price">
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10 mt-3">
                             ...
                             <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="buyOneGetOne" id="inlineRadio1" value="1" checked> Yes
                              </div>
                              <div class="form-check form-check-inline">
                             ...
                             <div class="form-check form-check-inline">
                              ...
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="buyOneGetOne" id="inlineRadio1" value="2" checked> No
                              </div>
                             @endif
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="inputName" value="{{old('waitingTime',$pizza->waiting_time)}}" name="waitingTime"placeholder="Enter waiting time">
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                             <textarea name="description" class="form-control" placeholder="Enter description"cols="30" rows="5">{{old('description',$pizza->description)}}</textarea>
                            </div>
